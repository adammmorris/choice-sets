...
for (subj in 1:length(subjlist)) {
  ...
  if (df.s2.subj.temp$comp_check_pass < .5 || df.s1.subj.temp$pctCorrect_words < .75 || df.s1.subj.temp$pctCorrect_val < .75 || df.s1.subj.temp$numTrials != 112 ||
      df.s2.subj.temp$numRepeats > 2 || sum(recalled[subj,]) < 5 || df.s2.subj.temp$numNAs > 3) {
...
include_rows = read.csv(paste0(path, 'include_rows.csv'), header = F)$V1
include_names = subjlist[include_rows]
...
weights_v3 = c(4.77e-03,3.39e-01,2.81e-01,1.35e-01,5.66e-08,7.13e-07,2.19e-01,1.71e-01,4.81e-01,3.93e-01,3.66e-07,4.26e-07,6.11e-01,1.03e-07,4.30e-01,4.91e-07,4.27e-01,3.12e-01,5.10e-08,1.92e-07,2.13e-01,3.15e-07,4.66e-01,3.24e-01,3.00e-07,1.82e-08,4.67e-07,2.49e-01,6.64e-08,01,5.51e-01,2.77e-01,5.87e-02,9.51e-08,2.25e-06,3.52e-01,2.24e-07,2.37e-08,2.34e-01,4.10e-01,1.48e-02,2.44e-01,2.32e-07,7.38e-01,3.70e-01,3.09e-01,5.10e-08,1.36e-08,2.64e-01,4.60e-07,2.58e-01,8.76e-01,7.84e-08,1.79e-01,7.75e-08,2.93e-01,3.77e-01,1.07e-06,4.94e-01,9.44e-03,5.42e-08,1.75e-01,1.71e-07,3.25e-01,5.54e-02,5.18e-01,2.25e-01,01,3.67e-06,2.31e-07,3.63e-02,7.15e-07,3.65e-08,3.35e-01,3.02e-01,1.73e-01,3.42e-01,3.14e-01,1.50e-07,6.03e-07,2.71e-01,1.96e-01,2.10e-01,2.09e-01,6.92e-07,4.37e-01,4.71e-08,7.21e-02,4.33e-01,1.81e-07,4.41e-01,9.05e-08,7.86e-03,1.70e-01,8.16e-01,4.49e-02,9.68e-08,1.80e-01,2.46e-01,4.23e-01,2.13e-08,2.28e-07,7.46e-07,2.06e-08,5.37e-08,4.69e-01,1.22e-01,01,1.62e-01,3.43e-01,1.60e-07,1.14e-08,4.24e-01,1.82e-01,3.67e-01,1.41e-06,5.50e-09,3.16e-01,01,2.87e-01)
coefs = coef(m.order)$subject$high_valTRUE
cor.test(coefs, weights_v3)
